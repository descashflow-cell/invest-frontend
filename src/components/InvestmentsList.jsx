...
export default function InvestmentsList({ onChanged, categories }) {
              ...
              {startingInvestments.map((it) => (
                ...
                >
                  {editingIds.has(it.id) && (
                    <div
                      className="mt-5 p-4 border border-white/10 rounded-xl bg-white/[0.02] sm:flex sm:gap-3 sm:items-center sm:justify-between"
                      data-testid="add-investment-form"
                    >
                      <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
                        <Autocomplete
