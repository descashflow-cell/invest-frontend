    ...
    >
      ...
      {!hasData ? (
        <div className="mt-6 flex-1 flex items-center justify-center text-sm text-neutral-600 border border-dashed border-white/10 rounded-xl">
          {loading ? "—" : "Aggiungi investimenti per vedere l'allocazione"}
        </div>
      ) : (
